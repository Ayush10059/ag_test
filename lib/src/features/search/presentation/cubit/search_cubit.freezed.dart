...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({FormStatus status, String searchText, String path});
...
class _$SearchStateImpl extends _SearchState {
  ...
  @override
  String toString() {
    return 'SearchState(status: $status, searchText: $searchText, path: $path)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, searchText, path);
...
abstract class _SearchState extends SearchState {
  const factory _SearchState(
      ...
      required final String path}) = _$SearchStateImpl;
